...
| 6. Packs & worldbuilder | **OPENED** — iter-109, the owner's call («можем его начинать», the iter-55/73 opener precedent, D-146; the opening landed: PACK_SPEC written, ref-18/ref-20 dives, the gut-check verdict — no cuts, the travel shape pinned) | pack system, mode G, pack CI; the build column: world-2 L1 the reskin day (the gate instrument), roads-1, res-1, world-2 L2 the province | a new T1 reskin without core edits, ≤1 day | else the module contract is wrong |
