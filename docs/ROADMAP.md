...
| 5. Depth | parked — UNLOCKED by the phase-4 gate (opens on the owner's call, the iter-55 precedent) | lazy worldgen, factions with goals, long history | an emergent chain of 3+ events without the player | else weak faction model |
