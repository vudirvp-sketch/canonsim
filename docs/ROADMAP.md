...
| 5. Depth | **OPEN** — opened iter-73, the owner's start call (D-105; the iter-55/36 opener precedent) | lazy worldgen, factions with goals, long history | an emergent chain of 3+ events without the player | else weak faction model |
